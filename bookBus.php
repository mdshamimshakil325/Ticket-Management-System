...
<html>
<link rel="stylesheet" href="style/bookBus.css">
		...
		<fieldset>
			<form action="" onsubmit="return validate()" method="post">
				<table align="center" >
					...
					<tr>
						<td  colspan="2"><input class="button" type="submit" value="Book Bus"></td>
						<td><a class="button2" style="text-decoration:none" href="paymentway.php" target="_self" >PAYMENT &nbsp</a></td>
