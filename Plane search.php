...
<?php
		function updateuser($name,$from,$to,$day,$month,$fare,$num,$departure,$noseat,$plane){
        $query = "update user set Froms='$from',Tos='$to',Ticket_Date='2021-$month-$day',Salary='$fare',Phone='$num',From_Time='$departure',Seat_Number='$noseat',Bus_Name='$plane',Booking='Pending',Refund=NULL where Username='$name'";
