...
<html>
<link rel="stylesheet" href="style/addBus.css">
      <head>
            ...
            <form action="" method="post" onsubmit="return validateBus()">
               <table align="center">
                     ...
                     <tr>
                        ...
                        <tr>
                             <td><input class="inputButton" type="submit" name="bus" value="Add Buses"></td>
                            <td><a class="seeBuses" style="text-decoration:none" href="allBus.php">See buses &nbsp</a> </td> 
